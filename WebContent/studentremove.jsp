...
<body>
 ...
 <!--  <li class="dropdown" style="float:right">
  ...
  <li class="dropdown" style="float:right">
    ...
    <div class="dropdown-content">
      <a href="OrderView">Add Companies</a>
      <a href="History">Remove Companies</a>
    </div>
  </li>
  
<!--  <li style="float:right"><a href="#history.jsp">History</a></li> -->
  
</ul><br>
<div class="bigbox" style="width=100%";align="center">
		<h2 align="center">ADMIN</h2>
		<form name="deletionform" action=StudentRemove>
			<table align="center">
				<br/>
				<br/>
				<tr>
